...
const NotificationPreferences = lazy(() => import("./pages/student/NotificationPreferences"));
...
const MobileAIQuiz             = lazy(() => import("./pages/m/MobileAIQuiz"));
const MobileWritingCoach       = lazy(() => import("./pages/m/MobileWritingCoach"));
const MobileGrammarCoach       = lazy(() => import("./pages/m/MobileGrammarCoach"));
...
const MobileAITutor            = lazy(() => import("./pages/m/MobileAITutor"));
const MobileLearningPath       = lazy(() => import("./pages/m/MobileLearningPath"));
const MobileLevelExams         = lazy(() => import("./pages/m/MobileLevelExams"));
const MobileLevelExamTaking    = lazy(() => import("./pages/m/MobileLevelExamTaking"));
const MobileSpeakingScenes     = lazy(() => import("./pages/m/MobileSpeakingScenes"));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/ayarlar/bildirimler"><LayoutWrapper component={NotificationPreferences} allowedRoles={['student', 'admin', 'teacher']} /></Route>
        ...
        <Route path="/m/pratik/akilli-quiz"><LayoutWrapper component={MobileAIQuiz} allowedRoles={['student', 'admin', 'teacher']} featureKey="student-ai-quiz" noLayout /></Route>
        <Route path="/m/pratik/yazma-kocu"><LayoutWrapper component={MobileWritingCoach} allowedRoles={['student', 'admin', 'teacher']} featureKey="student-writing-coach" noLayout /></Route>
        <Route path="/m/pratik/dilbilgisi-kocu"><LayoutWrapper component={MobileGrammarCoach} allowedRoles={['student', 'admin', 'teacher']} featureKey="student-grammar-coach" noLayout /></Route>
        ...
        <Route path="/m/pratik/ai-ogretmen"><LayoutWrapper component={MobileAITutor} allowedRoles={['student', 'admin', 'teacher']} featureKey="student-ai-tutor" noLayout /></Route>
        <Route path="/m/pratik/ogrenme-yolu"><LayoutWrapper component={MobileLearningPath} allowedRoles={['student', 'admin', 'teacher']} featureKey="student-learning-path" noLayout /></Route>
        <Route path="/m/pratik/seviye-sinavlari"><LayoutWrapper component={MobileLevelExams} allowedRoles={['student', 'admin', 'teacher']} featureKey="student-level-exams" noLayout /></Route>
        <Route path="/m/pratik/seviye-sinavlari/:level"><LayoutWrapper component={MobileLevelExamTaking} allowedRoles={['student', 'admin', 'teacher']} featureKey="student-level-exams" noLayout /></Route>
        <Route path="/m/pratik/konusma-sahneleri"><LayoutWrapper component={MobileSpeakingScenes} allowedRoles={['student', 'admin', 'teacher']} featureKey="student-speaking-scenes" noLayout /></Route>
        ...
        {/* Marketing site kurs kataloğu (bireysel grup programları) */}
