...
import {
  ...
  Sparkles, ChevronDown, Brain, Briefcase, Presentation, Wand2, Compass, Bot, Activity, UserPlus, ShoppingBag, Phone, UserCircle, Ticket, HardDrive, Package, Receipt, Mail, ChevronLeft, ChevronRight, Calendar, Newspaper, BookMarked
} from "lucide-react";
...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation: Record<string, NavItem[]> = {
    student: [
      ...
      { name: 'Konuşma Koçu',        href: '/student/pronunciation-coach',    icon: Mic,           moduleKey: 'student-pronunciation-coach', group: 'ai-studio' },
      ...
      { name: 'Akıllı Quiz',         href: '/student/ai-quiz',               icon: Wand2,         moduleKey: 'student-ai-quiz',              group: 'ai-studio' },
      { name: 'Kişisel AI Öğretmen', href: '/student/ai-tutor',              icon: GraduationCap, moduleKey: 'student-ai-tutor',             group: 'ai-studio' },
      { name: 'Öğrenme Yolu',        href: '/student/learning-path',         icon: Compass,       moduleKey: 'student-learning-path',        group: 'ai-studio' },
      { name: 'Seviye Sınavları',    href: '/student/level-exams',           icon: GraduationCap, moduleKey: 'student-level-exams' },
    ...
    admin: [
      ...
      { name: 'AI İçerik Üretici',   href: '/admin/ai-icerik',                icon: Sparkles },
