...
async function ensureAdditionalTopics() {
  ...
  const extra: Array<{ bookId: number; level: string; title: string; content: string; displayOrder: number }> = [
    ...
    // ─── A1 EK KONULAR ───────────────────────────────────
    { bookId: book1.id, level: "A1", displayOrder: 10, title: "Subject & Object Pronouns (Kişi Zamirleri)", content: "Pronouns replace nouns. Subject pronouns do the action; object pronouns receive it.\nSUBJECT PRONOUNS: I, you, he, she, it, we, they. Come BEFORE the verb: I love pizza. She reads books.\nOBJECT PRONOUNS: me, you, him, her, it, us, them. Come AFTER the verb or preposition: She loves ME. Call HIM. Give it to THEM.\nSUBJECT ↔ OBJECT PAIRS: I/me, he/him, she/her, we/us, they/them (you and it are same).\nEXAMPLES: He gave her a book. We saw them yesterday. This gift is for you. She likes me.\nPOSSESSIVE ADJECTIVES (before noun): my, your, his, her, its, our, their. This is MY car. That is HER bag.\nPOSSESSIVE PRONOUNS (alone): mine, yours, his, hers, ours, theirs. This car is MINE. That bag is HERS.\nDIFFERENCE: 'My car is red.' (adjective + noun) vs 'The red car is mine.' (pronoun alone).\nCOMMON MISTAKES: Never say 'Me is happy' (use I). Never say 'Give it to I' (use me). Never say 'This is mine book' (use my)." },
    { bookId: book1.id, level: "A1", displayOrder: 11, title: "Articles (A / An / The)", content: "Articles are small words before nouns. English has 3 articles: a, an, the.\nA / AN (indefinite — one of many, or first mention):\nA = before consonant SOUND: a book, a car, a university (yoo-ni-ver-si-ty starts with 'y' sound).\nAN = before vowel SOUND: an apple, an hour (silent h), an MBA (em-B-A).\nUSE: When mentioning something for the first time, or any one of a group. 'I bought a car.' 'She has an idea.'\nTHE (definite — specific, both speaker & listener know):\nUSE 1 — SECOND MENTION: 'I bought a car. The car is red.'\nUSE 2 — UNIQUE THINGS: the sun, the moon, the world, the president, the internet.\nUSE 3 — SUPERLATIVES / ORDINALS: the best, the biggest, the first, the last.\nUSE 4 — MUSICAL INSTRUMENTS: I play the piano/guitar.\nUSE 5 — SEAS, RIVERS, OCEANS: the Bosphorus, the Nile, the Atlantic Ocean.\nNO ARTICLE:\n- Plural/uncountable general: I like cats. Water is essential. (NOT 'the cats', 'the water')\n- Meals: I had breakfast. (NOT 'the breakfast')\n- Countries (mostly): Turkey, Germany. EXCEPTIONS: the UK, the USA, the Netherlands, the Philippines.\n- Languages: I speak English/Turkish. (NOT 'the English')\nCOMMON TURKISH MISTAKE: Turkish has no articles, so learners often forget them. Add 'a/an' before singular countable nouns: 'I have a car' (NOT 'I have car')." },
    { bookId: book1.id, level: "A1", displayOrder: 12, title: "There Is / There Are", content: "'There is' and 'there are' introduce the existence of something in a place.\nSINGULAR: There is + singular noun. 'There is a book on the table.' 'There is milk in the fridge.'\nPLURAL: There are + plural noun. 'There are three chairs.' 'There are many people here.'\nUNCOUNTABLE: Always with 'there is'. 'There is water in the bottle.' 'There is a lot of noise.'\nNEGATIVE: There isn't (there is not) / There aren't (there are not). 'There isn't any coffee.' 'There aren't enough chairs.'\nQUESTION: Is there + singular? / Are there + plural? 'Is there a bank near here?' 'Are there any restaurants?'\nSHORT ANSWERS: Yes, there is / No, there isn't. Yes, there are / No, there aren't.\nWITH QUANTIFIERS: There is some / any / no / a lot of / much / a little (uncountable). There are some / any / no / a lot of / many / a few (countable).\nCOMMON MISTAKES:\n- Do NOT confuse with 'it is': 'It is a book' (identify) vs 'There is a book' (existence).\n- With MIXED lists: use 'there is' with the FIRST item. 'There is a book, two pens, and a laptop on the desk.'\nCONTRACTION: 'There's' (there is) — very common. 'There're' (there are) — rarely written." },
    { bookId: book1.id, level: "A1", displayOrder: 13, title: "Have Got / Have (Sahiplik)", content: "'Have got' and 'have' both express possession, relationships, and characteristics. British vs American variation.\nHAVE GOT (British English, informal, common):\nPOSITIVE: I've got / You've got / He's got / She's got / It's got / We've got / They've got + noun. 'I've got a car.' 'She's got two sisters.'\nNEGATIVE: I haven't got / He hasn't got. 'I haven't got any money.' 'He hasn't got a job.'\nQUESTION: Have I got / Has she got. 'Have you got a pen?' 'Has he got time?'\nSHORT ANSWERS: Yes, I have / No, I haven't. Yes, she has / No, she hasn't.\nHAVE (American English, formal, universal):\nPOSITIVE: I have / He has + noun. 'I have a car.' 'She has two sisters.'\nNEGATIVE: I do not (don't) have / He does not (doesn't) have. 'I don't have money.'\nQUESTION: Do I have / Does she have. 'Do you have a pen?' 'Does he have time?'\nUSAGE — both mean the same for:\n- Possession: I have (got) a laptop.\n- Family: I have (got) two brothers.\n- Physical description: She has (got) blue eyes.\n- Illness: He has (got) a headache.\nOTHER USES OF 'HAVE' (NOT interchangeable with 'have got'):\n- Actions: have breakfast, have a shower, have a good time — always use 'have', never 'have got'.\nCOMMON MISTAKES: 'I have got' → 'I've got' (never 'I have got a car' in the negative — use 'haven't got'). Turkish learners often forget the -s: 'He has got' (correct), NOT 'He have got'." },
    { bookId: book1.id, level: "A1", displayOrder: 14, title: "Can (Yetenek, İzin, Rica)", content: "'Can' is a modal verb expressing ability, permission, possibility, and requests. It never changes form.\nFORM: Can + base verb (no 'to', no -s). Same for all subjects: I can, you can, she can, we can.\nNEGATIVE: Cannot / can't. 'I can't swim.' 'She can't speak French.'\nQUESTION: Can + subject + base verb? 'Can you help me?' 'Can she drive?'\nSHORT ANSWERS: Yes, I can / No, I can't.\nUSE 1 — ABILITY (present): 'I can speak English.' 'She can play the piano.' 'Fish can swim.'\nUSE 2 — PERMISSION: 'You can leave early today.' 'Can I use your phone?' 'Students can't smoke here.'\nUSE 3 — REQUEST: 'Can you open the door, please?' 'Can I have a coffee?'\nUSE 4 — POSSIBILITY: 'It can be cold in winter.' 'Accidents can happen.'\nPAST FORM: 'could' + base verb. 'When I was young, I could run fast.'\nFUTURE ABILITY: Use 'will be able to' (not 'will can'). 'She will be able to speak French soon.'\nFORMAL PERMISSION: 'May' is more formal. 'May I come in?' (very polite).\nCOMMON MISTAKES:\n- Never add -s: 'She can swims' → 'She can swim.'\n- Never use 'to': 'I can to swim' → 'I can swim.'\n- Negative contraction: 'can not' → 'cannot' or 'can't' (never 'can'nt')." },

    // ─── A2 EK KONULAR ───────────────────────────────────
    { bookId: book1.id, level: "A2", displayOrder: 15, title: "Adverbs of Frequency (Sıklık Zarfları)", content: "Adverbs of frequency tell HOW OFTEN something happens. Position matters.\nFREQUENCY SCALE: always (100%), usually (~90%), often (~70%), sometimes (~50%), occasionally (~30%), rarely / seldom (~10%), never (0%).\nPOSITION RULE 1 — with regular verbs: BEFORE the main verb. 'I always drink coffee.' 'She never eats meat.' 'We sometimes go to the cinema.'\nPOSITION RULE 2 — with 'to be': AFTER the verb 'be'. 'I am always late.' 'She is never at home.' 'They are usually happy.'\nPOSITION RULE 3 — in questions: after subject. 'Do you always study?' 'Are they usually on time?'\nPOSITION RULE 4 — in negatives: BEFORE the main verb (after do/does + not). 'I don't always eat breakfast.' 'She doesn't often call.'\nMULTI-WORD FREQUENCY (sentence beginning or end): every day, every week, once a week, twice a month, three times a year, on Mondays, at weekends, in the morning.\nEXAMPLES: I go to the gym twice a week. She calls her mother every Sunday.\n'HOW OFTEN?' QUESTION: 'How often do you exercise?' — 'I exercise three times a week.'\nCOMMON MISTAKES:\n- Wrong position: 'I go always to work' → 'I always go to work.'\n- 'Never' + negative: 'I don't never go' → 'I never go.' (never is already negative)." },
    { bookId: book1.id, level: "A2", displayOrder: 16, title: "Must / Have To (Zorunluluk)", content: "'Must' and 'have to' express obligation and necessity, but there are subtle differences.\nMUST — personal obligation, strong feeling, rules:\nFORM: must + base verb (no -s, same for all subjects). 'I must call my mother.' 'You must wear a helmet.'\nNEGATIVE 'MUSTN'T' — prohibition (not allowed): 'You mustn't smoke here.' 'Children mustn't play on the road.'\nHAVE TO — external obligation (rules, laws, someone else made this rule):\nFORM: have to / has to + base verb. 'I have to work on Saturdays.' 'She has to wear a uniform.'\nNEGATIVE 'DON'T/DOESN'T HAVE TO' — not necessary (free to choose): 'You don't have to come.' 'She doesn't have to pay.'\nDIFFERENCE — MUST vs HAVE TO:\n- 'I must exercise more.' (I feel this is important — my choice)\n- 'I have to exercise. Doctor's orders.' (someone else told me)\n- 'You mustn't be late.' (it's forbidden — negative rule)\n- 'You don't have to be there early.' (it's not required — you can choose)\nPAST FORM: 'had to' for both. 'I had to leave early yesterday.' No past for 'must'.\nFUTURE: 'will have to' for both. 'You will have to work harder.'\nQUESTION: 'Do you have to work tomorrow?' (common) vs 'Must I go?' (formal/less common).\nCOMMON MISTAKES:\n- 'must' has NO past — use 'had to': 'I must go yesterday' → 'I had to go yesterday.'\n- 'mustn't' ≠ 'don't have to': 'You mustn't stay' (forbidden) vs 'You don't have to stay' (optional)." },
    { bookId: book1.id, level: "A2", displayOrder: 17, title: "Should / Shouldn't (Öneri ve Tavsiye)", content: "'Should' gives advice and expresses what is right or expected.\nFORM: should + base verb. Same for all subjects. 'You should drink more water.' 'He should study harder.'\nNEGATIVE: shouldn't (should not) + base verb. 'You shouldn't eat so much sugar.' 'They shouldn't be late.'\nQUESTION: Should + subject + base verb? 'Should I call her?' 'What should we do?'\nUSE 1 — GIVING ADVICE: 'You should see a doctor.' 'You shouldn't work so late.'\nUSE 2 — ASKING FOR ADVICE: 'What should I wear?' 'Should I apologize?'\nUSE 3 — EXPECTATION: 'The train should arrive at 6.' 'She should be home by now.'\nUSE 4 — MORAL OR CORRECT ACTION: 'You should always tell the truth.' 'Children shouldn't watch violent films.'\nALTERNATIVES:\n- OUGHT TO (formal, less common): 'You ought to see a doctor.' (same meaning as 'should')\n- HAD BETTER (stronger warning): 'You'd better leave now — the bus is coming.'\n- MUST (very strong): 'You must see this film — it's amazing.' (should = mild advice; must = strong recommendation)\nCOMMON MISTAKES:\n- Never say 'shoulds' or 'shoulded' — should never changes form.\n- 'You should to go' → 'You should go.' (no 'to')\n- Turkish 'yapmalısın' can mean both 'should' (advice) and 'must' (obligation). Choose based on context." },
    { bookId: book1.id, level: "A2", displayOrder: 18, title: "Suggestions (Let's / How about / Why don't we)", content: "Different structures for making suggestions in English.\nLET'S + BASE VERB (informal, group suggestion, includes speaker):\n'Let's go to the cinema.' 'Let's have dinner together.' 'Let's not talk about work.'\nRESPONSE: 'Good idea!' 'OK, let's do that.' 'Sorry, I can't.'\nHOW ABOUT / WHAT ABOUT + -ing OR NOUN:\n'How about going to the beach?' 'What about a coffee?' 'How about Italian food?'\nUSE: Very common in casual conversation to propose an activity.\nWHY DON'T WE + BASE VERB:\n'Why don't we take a break?' 'Why don't we meet at 7?' 'Why don't we try that new restaurant?'\nWHY DON'T YOU + BASE VERB (advice to another person):\n'Why don't you talk to him?' 'Why don't you rest?'\nSHALL WE + BASE VERB (formal, mostly British):\n'Shall we begin?' 'Shall we sit down?'\nI SUGGEST / I RECOMMEND + -ing OR that-clause (formal):\n'I suggest going by taxi.' 'I recommend that you try the fish.'\nCOULD/CAN + BASE VERB (softer suggestion):\n'We could try the new café.' 'You could ask your teacher.'\nRESPONDING TO SUGGESTIONS:\n- Accepting: Sure! / Sounds good! / Great idea! / Why not?\n- Refusing politely: I'd love to, but... / Actually, I'd prefer... / Maybe another time.\nCOMMON MISTAKES:\n- 'Let's to go' → 'Let's go' (no 'to' after Let's).\n- 'How about go' → 'How about going' (need -ing after How about).\n- 'Let us go' is very formal — 'Let's go' is normal spoken English." },
    { bookId: book1.id, level: "A2", displayOrder: 19, title: "Prepositions of Time (In / On / At)", content: "Three main prepositions for time — each has specific rules.\nIN — used with longer periods, months, years, seasons, parts of day:\n- Months: in January, in December\n- Years: in 2024, in 1999\n- Seasons: in summer, in winter\n- Centuries/decades: in the 21st century, in the 90s\n- Parts of day: in the morning, in the afternoon, in the evening (BUT: at night!)\n- Time periods: in 5 minutes, in a week, in the past\nON — used with specific days and dates:\n- Days: on Monday, on Sunday\n- Dates: on 15th August, on my birthday, on New Year's Day\n- Day + part: on Monday morning, on Friday night\n- Specific occasions: on Christmas Day, on the weekend (American: 'on weekends')\nAT — used with specific times and short expressions:\n- Clock times: at 3 o'clock, at 7:30\n- Meal times: at lunch, at breakfast, at dinner\n- Night (exception!): at night\n- Weekend (British): at the weekend, at weekends\n- Holidays (without 'day'): at Christmas, at Easter, at New Year\n- Fixed expressions: at the moment, at the same time, at the beginning/end\nNO PREPOSITION with 'this', 'last', 'next', 'every', 'all':\n- 'I saw her last week' (NOT 'in last week')\n- 'I'll call you next Monday' (NOT 'on next Monday')\n- 'Every summer we go camping.'\nCOMMON MISTAKES: at Monday → on Monday. in 3 o'clock → at 3 o'clock. on morning → in the morning. Turkish learners often say 'in Monday' — it's 'on Monday'." },
    { bookId: book1.id, level: "A2", displayOrder: 20, title: "Present Perfect Introduction (Ever, Never, Already, Yet)", content: "Present Perfect at A2 level: life experiences and recently completed actions.\nFORM: Subject + have/has + past participle.\nEVER (questions): Have you ever eaten sushi? Has she ever been to London?\nNEVER (negative experience): I have never eaten sushi. We have never tried skiing.\nALREADY (sooner than expected): I have already finished my homework. She has already left.\nYET (negatives/questions — expected to happen): I haven't finished yet. Has he called yet?\nJUST (very recently): I have just arrived. She has just called.\nIRREGULAR PAST PARTICIPLES: go->gone/been. see->seen. eat->eaten. do->done. have->had. make->made. take->taken. write->written.\nPP vs PAST SIMPLE: 'Have you ever visited Rome?' (experience, no time) vs 'I visited Rome in 2019.' (specific time).\nCOMMON: Have you ever been to...? I've never felt like this. Have you done your homework yet?" },
