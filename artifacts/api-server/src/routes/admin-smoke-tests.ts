...
const TESTS: TestDef[] = [
  ...
  { id: "admin-bundles", category: "Admin Listings", name: "E-kitap paketleri", method: "GET", path: "/api/admin/bundles", auth: true },
  { id: "public-bundles", category: "Public", name: "Bundles listesi (public)", method: "GET", path: "/api/bundles" },
  { id: "public-bundles-featured", category: "Public", name: "Öne çıkan bundles", method: "GET", path: "/api/bundles/featured" },
