...
// Postgres BYTEA — CV PDF binary olarak saklanır.
// Şema'da TANIMLI OLMASI ZORUNLU: aksi halde `drizzle-kit push --force`
// kolonu DB'den siler (önce yaşadığımız sorun).
